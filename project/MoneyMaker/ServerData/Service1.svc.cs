...
namespace ServerData
{
    ...
    public class Service1 : IService1
    {
        ...
        {
            MoneyMaker.Income_History.add(userid, description, income, date, type, ID, typegroup, typestring);
        }
        public DataTable Income_History_selectsingle(int id)
        {
            return MoneyMaker.Income_History.selectsingle(id);
        }
        public DataTable Income_History_selectspecific(int userid, string des, int income, string date1, string date2, int type, int ID, string typegroup, string typestring)
        {
            return MoneyMaker.Income_History.selectspecific(userid, des, income, date1, date2, type, ID, typegroup, typestring);
        }
        ...
        {
            MoneyMaker.Income_History.update(id, description, income, date, type, typegroup, typestring);
        }
        ...
        {
            MoneyMaker.Outcome_History.AddProduct(userid, typeid, price, product, date, ID, typegroup, typestring);
        }
        ...
        public DataTable Outcome_History_Getproducts(int userid, int typeid, int price, string product, string date1, string date2, int ID, string typegroup, string typestring)
        {
            return MoneyMaker.Outcome_History.Getproducts(userid, typeid, price, product, date1, date2, ID, typegroup, typestring);
        }
        ...
        {
            MoneyMaker.Outcome_History.SetProduct(proid, typeid, price, product, date, typegroup, typestring);
        }
        ...
        public DataTable Type_Group_Suggestion_getall()
        {
        ...
        {
            MoneyMaker.Users.Register(fname, lname, password, money, mtype, date, email);
        }
        public int Users_Login(string email, string password)
        {
            return MoneyMaker.Users.Login(email, password);
        }
        public DataTable Users_getall()
        {
            return MoneyMaker.Users.getall();
        }
        public string Users_getpassword(int id)
        {
            return MoneyMaker.Users.getpassword(id);
        }
        public DataTable Users_get_specific(string fname, string lname, string pass, int money1, int money2, string moneytype, string date1, string date2, bool admin, string email)
        {
            return MoneyMaker.Users.get_specific(fname, lname, pass, money1, money2, moneytype, date1, date2, admin, email);
        }
        public void Users_Change(int id, string fname, string lname, string password, string email)
        {
            MoneyMaker.Users.Change(id, fname, lname, password, email);
        }
        public void Users_addmoney(int toadd, int userid, char ioro)
        {
            MoneyMaker.Users.addmoney(toadd, userid, ioro);
        }
        public int Users_getmoney(int id)
        {
            return MoneyMaker.Users.getmoney(id);
        }
        public DateTime Users_get_user_reg_date(int id)
        {
            return MoneyMaker.Users.get_user_reg_date(id);
        }
        public bool Users_is_admin(int id)
        {
            return MoneyMaker.Users.is_admin(id);
        }
        public void Users_make_admin(int id)
        {
            MoneyMaker.Users.make_admin(id);
        }
        public void Users_nomake_admin(int id)
        {
            MoneyMaker.Users.nomake_admin(id);
        }
        public void Users_clean_user_data(int id)
        {
            MoneyMaker.Users.clean_user_data(id);
        }
        public int Users_getallincome(int id)
        {
            return MoneyMaker.Users.getallincome(id);
        }
        public int Users_getalloutcome(int id)
        {
            return MoneyMaker.Users.getalloutcome(id);
        }
        public bool Users_check_email_duplicate(string email)
        {
            return MoneyMaker.Users.check_email_duplicate(email);
        }
        public void getaddress(string path)
        {
            MoneyMaker.oledbhelper.getaddress(path);
        }
