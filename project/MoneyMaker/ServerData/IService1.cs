...
namespace ServerData
{
    ...
    public interface IService1
    {
        ...
        [OperationContract]
        DataTable Income_History_selectspecific(int userid, string des, int income, string date1, string date2, int type, int ID, string typegroup, string typestring);
        [OperationContract]
        ...
        [OperationContract]
        DataTable Outcome_History_Getproducts(int userid, int typeid, int price, string product, string date1, string date2, int ID, string typegroup, string typestring);
        [OperationContract]
        ...
        [OperationContract]
        DataTable Users_getall();
        [OperationContract]
        string Users_getpassword(int id);
        [OperationContract]
        DataTable Users_get_specific(string fname, string lname, string pass, int money1, int money2, string moneytype, string date1, string date2, bool admin, string email);
        [OperationContract]
        ...
        [OperationContract]
        DateTime Users_get_user_reg_date(int id);
        [OperationContract]
